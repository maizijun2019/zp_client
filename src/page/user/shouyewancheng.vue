<template>
  ...
  <el-table :data="tableData" style="width: 100%">
    ...
    <el-table-column prop="projectid" label="详情" width='100'>
       <template slot-scope="scope">
         <router-link :to="{name:'UserIndexBanZhongXiang',query:{'oid':scope.row.order_id,'type':4}}" class="xaingbtn">查看详情</router-link>
      </template>
    </el-table-column>
  </el-table>
  ...
  export default{
    ...
    methods:{
      ...
      getShuFn(num)
      {
        ...
        that.Com.request({
          pageIndex:num_
          },'personalCenter/Index/complete',function(res){
